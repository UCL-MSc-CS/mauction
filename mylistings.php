...
<?php
  ...
  // the shared "utilities.php" where they can be shared by multiple files.
    ...
    $listingquery = "SELECT userID, itemName, description, startPrice, commission, endDate FROM auctions ORDER BY itemName ASC"; // need to add WHERE userID in (SELECT userID FROM users WHERE username = '$username')
    $listresult = mysqli_query($connection, $listingquery) or die('Error making select users query' . mysqli_error());
